...
static const uint32_t MODE_LENGTH[] = {
	LENGTH_WORD, LENGTH_WORD, LENGTH_WORD, LENGTH_WORD, LENGTH_WORD, LENGTH_NONE, LENGTH_BYTE, LENGTH_NONE,
	LENGTH_BYTE, LENGTH_NONE, LENGTH_BYTE, LENGTH_BYTE, LENGTH_BYTE, LENGTH_BYTE, LENGTH_BYTE, LENGTH_BYTE,
	};
