...
#ifndef SB65_COMMON_PROCESSOR_H_
#define SB65_COMMON_PROCESSOR_H_
...
typedef enum {
	// 0x00
	OPCODE_BRK_STACK = 0, OPCODE_ORA_ZERO_PAGE_INDIRECT_X, OPCODE_NOP_02_UNUSED, OPCODE_NOP_03_UNUSED,
	...
	// 0x20
	OPCODE_JSR_ABSOLUTE, OPCODE_AND_ZERO_PAGE_INDIRECT_X, OPCODE_NOP_22_UNUSED, OPCODE_NOP_23_UNUSED,
	...
	// 0x40
	OPCODE_RTI_STACK, OPCODE_EOR_ZERO_PAGE_INDIRECT_X, OPCODE_NOP_42_UNUSED, OPCODE_NOP_43_UNUSED,
	OPCODE_NOP_44_UNUSED, OPCODE_EOR_ZERO_PAGE, OPCODE_LSR_ZERO_PAGE, OPCODE_RMB4_ZERO_PAGE,
	// 0x48
	...
	OPCODE_NOP_54_UNUSED, OPCODE_EOR_ZERO_PAGE_X, OPCODE_LSR_ZERO_PAGE_X, OPCODE_RMB5_ZERO_PAGE,
	// 0x58
	OPCODE_CLI_IMPLIED, OPCODE_EOR_ABSOLUTE_Y, OPCODE_PHY_STACK, OPCODE_NOP_5B_UNUSED,
	OPCODE_NOP_5C_UNUSED, OPCODE_EOR_ABSOLUTE_X, OPCODE_LSR_ABSOLUTE_X, OPCODE_BBR5_ZERO_PAGE_RELATIVE,
	// 0x60
	OPCODE_RTS_STACK, OPCODE_ADC_ZERO_PAGE_INDIRECT_X, OPCODE_NOP_62_UNUSED, OPCODE_NOP_63_UNUSED,
	...
	// 0x80
	OPCODE_BRA_RELATIVE, OPCODE_STA_ZERO_PAGE_INDIRECT_X, OPCODE_NOP_82_UNUSED, OPCODE_NOP_83_UNUSED,
	...
	// 0xc0
	OPCODE_CPY_IMMEDIATE, OPCODE_CMP_ZERO_PAGE_INDIRECT_X, OPCODE_NOP_C2_UNUSED, OPCODE_NOP_C3_UNUSED,
	...
	OPCODE_NOP_D4_UNUSED, OPCODE_CMP_ZERO_PAGE_X, OPCODE_DEC_ZERO_PAGE_X, OPCODE_SMB5_ZERO_PAGE,
	// 0xd8
	OPCODE_CLD_IMPLIED, OPCODE_CMP_ABSOLUTE_Y, OPCODE_PHX_STACK, OPCODE_STP_IMPLIED,
	OPCODE_NOP_DC_UNUSED, OPCODE_CMP_ABSOLUTE_X, OPCODE_DEC_ABSOLUTE_X, OPCODE_BBS5_ZERO_PAGE_RELATIVE,
	// 0xe0
	OPCODE_CPX_IMMEDIATE, OPCODE_SBC_ZERO_PAGE_INDIRECT_X, OPCODE_NOP_E2_UNUSED, OPCODE_NOP_E3_UNUSED,
	...
	OPCODE_NOP_F4_UNUSED, OPCODE_SBC_ZERO_PAGE_X, OPCODE_INC_ZERO_PAGE_X, OPCODE_SMB7_ZERO_PAGE,
	// 0xf8
	OPCODE_SED_IMPLIED, OPCODE_SBC_ABSOLUTE_Y, OPCODE_PLX_STACK, OPCODE_NOP_FB_UNUSED,
	OPCODE_NOP_FC_UNUSED, OPCODE_SBC_ABSOLUTE_X, OPCODE_INC_ABSOLUTE_X, OPCODE_BBS7_ZERO_PAGE_RELATIVE,
} sb65_opcode_t;

static const sb65_mode_t MODE[] = {
	// 0x00
	MODE_STACK_0, MODE_ZERO_PAGE_INDIRECT_X, MODE_UNUSED_0, MODE_UNUSED_1,
	MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE,
	// 0x08
	MODE_STACK_1, MODE_IMMEDIATE, MODE_ACCUMULATOR, MODE_UNUSED_1,
	MODE_ABSOLUTE, MODE_ABSOLUTE, MODE_ABSOLUTE, MODE_ZERO_PAGE_RELATIVE,
	// 0x10
	MODE_RELATIVE, MODE_ZERO_PAGE_INDIRECT_Y, MODE_ZERO_PAGE_INDIRECT, MODE_UNUSED_1,
	MODE_ZERO_PAGE, MODE_ZERO_PAGE_X, MODE_ZERO_PAGE_X, MODE_ZERO_PAGE,
	// 0x18
	MODE_IMPLIED, MODE_ABSOLUTE_Y, MODE_ACCUMULATOR, MODE_UNUSED_1,
	MODE_ABSOLUTE, MODE_ABSOLUTE_X, MODE_ABSOLUTE_X, MODE_ZERO_PAGE_RELATIVE,
	// 0x20
	MODE_ABSOLUTE, MODE_ZERO_PAGE_INDIRECT_X, MODE_UNUSED_0, MODE_UNUSED_1,
	MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE,
	// 0x28
	MODE_STACK_2, MODE_IMMEDIATE, MODE_ACCUMULATOR, MODE_UNUSED_1,
	MODE_ABSOLUTE, MODE_ABSOLUTE, MODE_ABSOLUTE, MODE_ZERO_PAGE_RELATIVE,
	// 0x30
	MODE_RELATIVE, MODE_ZERO_PAGE_INDIRECT_Y, MODE_ZERO_PAGE_INDIRECT, MODE_UNUSED_1,
	...
	// 0x40
	MODE_STACK_3, MODE_ZERO_PAGE_INDIRECT_X, MODE_UNUSED_0, MODE_UNUSED_1,
	MODE_UNUSED_2, MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE,
	// 0x48
	MODE_STACK_1, MODE_IMMEDIATE, MODE_ACCUMULATOR, MODE_UNUSED_1,
	MODE_ABSOLUTE, MODE_ABSOLUTE, MODE_ABSOLUTE, MODE_ZERO_PAGE_RELATIVE,
	// 0x50
	MODE_RELATIVE, MODE_ZERO_PAGE_INDIRECT_Y, MODE_ZERO_PAGE_INDIRECT, MODE_UNUSED_1,
	MODE_UNUSED_3, MODE_ZERO_PAGE_X, MODE_ZERO_PAGE_X, MODE_ZERO_PAGE,
	// 0x58
	MODE_IMPLIED, MODE_ABSOLUTE_Y, MODE_STACK_1, MODE_UNUSED_1,
	MODE_UNUSED_4, MODE_ABSOLUTE_X, MODE_ABSOLUTE_X, MODE_ZERO_PAGE_RELATIVE,
	// 0x60
	MODE_STACK_3, MODE_ZERO_PAGE_INDIRECT_X, MODE_UNUSED_0, MODE_UNUSED_1,
	MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE,
	// 0x68
	...
	MODE_ZERO_PAGE_X, MODE_ZERO_PAGE_X, MODE_ZERO_PAGE_X, MODE_ZERO_PAGE,
	// 0x78
	MODE_IMPLIED, MODE_ABSOLUTE_Y, MODE_STACK_2, MODE_UNUSED_1,
	MODE_ABSOLUTE_INDIRECT_X, MODE_ABSOLUTE_X, MODE_ABSOLUTE_X, MODE_ZERO_PAGE_RELATIVE,
	// 0x80
	MODE_RELATIVE, MODE_ZERO_PAGE_INDIRECT_X, MODE_UNUSED_0, MODE_UNUSED_1,
	MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE,
	// 0x88
	MODE_IMPLIED, MODE_IMMEDIATE, MODE_IMPLIED, MODE_UNUSED_1,
	MODE_ABSOLUTE, MODE_ABSOLUTE, MODE_ABSOLUTE, MODE_ZERO_PAGE_RELATIVE,
	// 0x90
	MODE_RELATIVE, MODE_ZERO_PAGE_INDIRECT_Y, MODE_ZERO_PAGE_INDIRECT, MODE_UNUSED_1,
	MODE_ZERO_PAGE_X, MODE_ZERO_PAGE_X, MODE_ZERO_PAGE_Y, MODE_ZERO_PAGE,
	// 0x98
	MODE_IMPLIED, MODE_ABSOLUTE_Y, MODE_IMPLIED, MODE_UNUSED_1,
	MODE_ABSOLUTE, MODE_ABSOLUTE_X, MODE_ABSOLUTE_X, MODE_ZERO_PAGE_RELATIVE,
	// 0xa0
	MODE_IMMEDIATE, MODE_ZERO_PAGE_INDIRECT_X, MODE_IMMEDIATE, MODE_UNUSED_1,
	MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE,
	// 0xa8
	MODE_IMPLIED, MODE_IMMEDIATE, MODE_IMPLIED, MODE_UNUSED_1,
	MODE_ABSOLUTE, MODE_ABSOLUTE, MODE_ABSOLUTE, MODE_ZERO_PAGE_RELATIVE,
	...
	// 0xc0
	MODE_IMMEDIATE, MODE_ZERO_PAGE_INDIRECT_X, MODE_UNUSED_0, MODE_UNUSED_1,
	MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE,
	// 0xc8
	...
	MODE_UNUSED_3, MODE_ZERO_PAGE_X, MODE_ZERO_PAGE_X, MODE_ZERO_PAGE,
	// 0xd8
	MODE_IMPLIED, MODE_ABSOLUTE_Y, MODE_STACK_1, MODE_IMPLIED,
	MODE_UNUSED_5, MODE_ABSOLUTE_X, MODE_ABSOLUTE_X, MODE_ZERO_PAGE_RELATIVE,
	// 0xe0
	MODE_IMMEDIATE, MODE_ZERO_PAGE_INDIRECT_X, MODE_UNUSED_0, MODE_UNUSED_1,
	MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE, MODE_ZERO_PAGE,
	// 0xe8
...
#endif /* SB65_COMMON_PROCESSOR_H_ */
